...
if(params.multiqc){
 ...
 process read_correction {
     ...
     canu -correct -p corrected_reads -nanopore-raw subset.fastq genomeSize=${params.avg_amplicon_size} stopOnLowCoverage=1 minInputCoverage=2 minReadLength=1200
     ...
     cp ${cluster_id}_racon_.log ${workflow.launchDir}/${params.outdir}/${barcode}/
...
*     script:
*     """
*	 echo "id;reads_in_cluster" > ${barcode}.nanoclust_out.txt
* 
